...
class Application:
    def __init__(self):
        ...
        my_button = tk.Button(self.root, text="speak", font=("Comic Sans MS", 10, "bold"), bg="#E48F1B", fg="#34262B", command=talk)
        my_button.place(x=620, y=640)

        clear_button = tk.Button(self.root, text="Clear", font=("Comic Sans MS", 10, "bold"), bg="#E48F1B", fg="#34262B", command=clearWord)
        clear_button.place(x=720, y=600)

        clear_button1 = tk.Button(self.root, text="Clear", font=("Comic Sans MS", 10, "bold"), bg="#E48F1B", fg="#34262B", command=clearSentence)
        clear_button1.place(x=720, y=640)

        tts_button = tk.Button(self.root, text="Text to Sign Conversion", font=("Comic Sans MS", 14, "bold"), bg="#E48F1B", fg="#34262B", command=text_Sign)
